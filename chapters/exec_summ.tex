...
The issue of securely managing digital assets of higher monetary value (such as cryptocurrency holdings) in the event of the owner's death is considered afterwards.
...
\subsubsection*{Simplifying the process of transferring digital assets in the event of the owner's death} % (fold)
...
% to-do: include Future release
% In the short to mid terms, Legacy plans to deliver two main releases: Legacy v1.0 \textit{Memoirs} and Legacy v2.0 \textit{Heritage}---the main differences between both being in the underlying software architecture. 
% Further releases including enhanced capabilities---such as the ability to manage smart property and cryptocurrencies---are also considered over the medium and long terms, as technical and legal issues are overcome. 
% %This document focuses mainly on Legacy versions \textit{Memoirs} and \textit{Heritage}, which we may refer indistinctly to as Legacy in the following. 
...
\section{Upcoming Trends: Cryptocurrencies and Smart Property} % (fold)
...
At this stage, the challenges involved in implementing smart wills allowing for the disposal of any type of property are no longer technological, but more likely legal. Trading and transferring smart property will be easily achieved leveraging the benefits provided by the blockchain. % TO-DO 
